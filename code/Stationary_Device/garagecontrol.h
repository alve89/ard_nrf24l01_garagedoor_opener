...
void openDoor(uint8_t = CONFIG.getPinByName("relay")->getNumber(), bool = CONFIG.getPinByName("relay")->isInverted());
void closeDoor(uint8_t = CONFIG.getPinByName("relay")->getNumber(), bool = CONFIG.getPinByName("relay")->isInverted());
void triggerDoorRelay(uint8_t = CONFIG.getPinByName("relay")->getNumber(), bool = CONFIG.getPinByName("relay")->isInverted());
bool isDoorClosed();
