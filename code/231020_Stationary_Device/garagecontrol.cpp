...
void config::newPin(String pinName, uint8_t pinNumber, bool pinInverted) {
//   try {
...
config::pin::pin(String pinName, uint8_t pinNumber, bool pinInverted) {
    name = pinName;
    number = pinNumber;
...
config CONFIG;
EthernetClient net;
MQTTClient client(CONFIG.MQTT.maxPayloadSize);